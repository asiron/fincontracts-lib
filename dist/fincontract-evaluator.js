...
function makeEstimationEvaluators() {
  return {
    ...
    zero: () => () => makeArray(_currency2.default.CurrencyCount, [0, 0]),
    one: node => () => {
      const arr = makeArray(_currency2.default.CurrencyCount, [0, 0]);
 ...
 * @extends {Visitor}
 */
class EvaluatorVisitor extends _fincontractVisitor.Visitor {
...
exports.EvaluatorVisitor = EvaluatorVisitor; /**
